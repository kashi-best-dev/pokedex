async function FetchData(name) {
    ...
    try{
        ...
        document.getElementById("img").innerHTML=`<img class="img" src="failed.png" height="60px">`;
...
document.getElementById("img").innerHTML=`<img id="loader" src="pokeball.png" width="40px"></img>`;
